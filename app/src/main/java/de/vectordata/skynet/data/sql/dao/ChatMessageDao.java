...
public interface ChatMessageDao {
    ...
    @Query("SELECT * FROM chatMessages WHERE channelId=:channelId AND messageId>:messageIdMin ORDER BY messageId ASC")
    List<ChatMessage> queryAfter(long channelId, long messageIdMin);
